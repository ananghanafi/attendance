...
<head>
    ...
    <title>Form Absen - <?php echo e($user->nama); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="card">
        <div class="header">
            <h1>Form Absen</h1>
            <p><?php echo e($tanggalFormatted); ?></p>
        </div>

        <div class="user-info">
            <div class="user-avatar"><?php echo e(strtoupper(substr($user->nama, 0, 1))); ?></div>
        ...
        <form method="POST" action="<?php echo e(route('absen.store.standalone', ['nip' => $nip, 'tanggal' => $tanggal])); ?>" id="absenForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group">
                ...
                <div class="radio-group">
                    ...
                    <label class="radio-item <?php echo e(old('status') === $option['value'] ? 'selected' : ''); ?>">
                        <input
                            type="radio"
                            name="status"
                            value="<?php echo e($option['value']); ?>"
                            <?php echo e(old('status') === $option['value'] ? 'checked' : ''); ?>

                            onchange="handleStatusChange(this)">
                        <div class="radio-content">
                            <div class="radio-title"><?php echo e($option['label']); ?></div>
                            <div class="radio-desc"><?php echo e($option['desc']); ?></div>
                        </div>
                    </label>
            ...
            <div id="wfaFields" class="hidden">
                <div class="form-group">
                    ...
                    <select name="wfa_lokasi" class="form-select" onchange="handleWfaLokasiChange(this)">
                        ...
                        <option value="1" <?php echo e(old('wfa_lokasi') === '1' ? 'selected' : ''); ?>>Di Rumah</option>
                        <option value="2" <?php echo e(old('wfa_lokasi') === '2' ? 'selected' : ''); ?>>Di Luar Rumah</option>
                    </select>
                    <?php $__errorArgs = ['wfa_lokasi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group hidden" id="wfaDetailField">
                    ...
                    <input type="text" name="wfa_detail" class="form-input" placeholder="Contoh: Kafe XYZ, Coworking Space ABC" value="<?php echo e(old('wfa_detail')); ?>">
                    <?php $__errorArgs = ['wfa_detail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="wfa_alasan" class="form-textarea" placeholder="Jelaskan alasan WFA..."><?php echo e(old('wfa_alasan')); ?></textarea>
                    <?php $__errorArgs = ['wfa_alasan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div id="izinFields" class="hidden">
                <div class="form-group">
                    ...
                    <div class="date-row">
                        <div>
                            <input type="date" name="tanggal_from" class="form-input" value="<?php echo e(old('tanggal_from', date('Y-m-d'))); ?>">
                            <?php $__errorArgs = ['tanggal_from'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <input type="date" name="tanggal_to" class="form-input" value="<?php echo e(old('tanggal_to', date('Y-m-d'))); ?>">
                            <?php $__errorArgs = ['tanggal_to'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <textarea name="alasan" class="form-textarea" placeholder="Jelaskan alasan..."><?php echo e(old('alasan')); ?></textarea>
...
<?php /**PATH C:\Users\Kevannn\Documents\FILE MAGANG\AbsensiWika\resources\views/absen/standalone-form.blade.php ENDPATH**/ ?>