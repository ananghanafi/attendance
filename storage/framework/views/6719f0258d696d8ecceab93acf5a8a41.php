    ...
    <style>
        ...
        * {
        ...
        @media(max-width:900px) {
            ...
            /* Fix: Di mobile, text harus selalu terlihat saat sidebar dibuka */
            .sidebar.collapsed .sidebar-item {
                padding: 14px 24px;
            ...
            /* Fix: Di mobile, brand harus tampil full "WIKAGEDUNG" */
            .sidebar.collapsed .sidebar-brand .brand-full {
                display: block
            }
    ...
    <script>
        ...
        document.addEventListener("click", function(e) {
            if (window.innerWidth <= 900) {
                const s = document.getElementById("sidebar");
                const h = document.querySelector(".hamburger");
                if (s.classList.contains("open") && !s.contains(e.target) && !h.contains(e.target)) {
                    s.classList.remove("open");
                    h.classList.remove("active")
                }
            }
