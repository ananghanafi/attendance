  ...
  <body>
    <div class="wrap">
      <div class="top">
        <div>
          <h1>Setting User</h1>
          <div class="muted" style="font-size:12px">Kelola data user.</div>
        </div>
      ...
      <div class="card">
        <div class="grid">
          <a class="tile" href="{{ route('users.index') }}">
            <div class="t">View / Edit User</div>
            <div class="d">Lihat daftar user, lalu edit/hapus dari tabel.</div>
          </a>

          <a class="tile" href="{{ route('users.create') }}">
            <div class="t">Add User</div>
            <div class="d">Tambah user baru.</div>
          </a>
        </div>
      </div>
    </div>
