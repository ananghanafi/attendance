  ...
  <body>
    <div class="wrap">
      <div class="top">
        <div>
          <h1>Setting Biro</h1>
          <div class="muted" style="font-size:12px">Kelola master biro.</div>
        </div>
      ...
      <div class="card">
        <div class="grid">
          <a class="tile" href="{{ route('biro.index') }}">
            <div class="t">View / Edit Biro</div>
            <div class="d">Lihat daftar biro, lalu edit/hapus dari tabel.</div>
          </a>

          <a class="tile" href="{{ route('biro.create') }}">
            <div class="t">Add Biro</div>
            <div class="d">Tambah data biro baru.</div>
          </a>
        </div>
      </div>
    </div>
