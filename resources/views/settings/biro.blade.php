...
@section('title', 'WG Absen — Setting Biro')
...
@section('styles')
    ...
    .tile{background:#fff;border:2px solid #e5e7eb;border-radius:14px;padding:20px;transition:all 0.2s
    ease;cursor:pointer;text-decoration:none;display:block}
