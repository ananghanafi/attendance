  ...
  <body>
    <div class="wrap">
      <div class="top">
        <div>
          <h1>Setting Role</h1>
          <div class="muted" style="font-size:12px">Kelola master role.</div>
        </div>
      ...
      <div class="card">
        <div class="grid">
          <a class="tile" href="{{ route('role.index') }}">
            <div class="t">View / Edit Role</div>
            <div class="d">Lihat daftar role, lalu edit/hapus dari tabel.</div>
          </a>

          <a class="tile" href="{{ route('role.create') }}">
            <div class="t">Add Role</div>
            <div class="d">Tambah data role baru.</div>
          </a>
        </div>
      </div>
    </div>
