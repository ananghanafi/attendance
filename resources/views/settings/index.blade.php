                                    ...
                                    <tr class="biro-row">
                                        ...
                                        <td>
                                            <div style="display:flex;gap:6px;align-items:center">
                                                ...
                                                <form method="POST" action="{{ route('biro.destroy') }}"
                            ...
                            <tbody>
                                @forelse($jabatans as $j)
                                    <tr class="jabatan-row">
                                        ...
                                        <td>
                                            <div style="display:flex;gap:6px;align-items:center">
                                                <form method="POST" action="{{ route('jabatan.setEdit') }}"
                                                    style="margin:0">
                                                    @csrf
                                                ...
                                                <form method="POST" action="{{ route('jabatan.destroy') }}"
                            ...
                            <tbody>
                                @forelse($roles as $r)
                                    <tr class="role-row">
                                        ...
                                        <td>
                                            <div style="display:flex;gap:6px;align-items:center">
                                                <form method="POST" action="{{ route('role.setEdit') }}"
                                                    style="margin:0">
                                                    @csrf
