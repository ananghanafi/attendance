  ...
  <body>
    <div class="wrap">
      <div class="top">
        <div>
          <h1>Data Role</h1>
          <div class="muted" style="font-size:12px">Tambah + edit + delete role.</div>
        </div>
        <div style="display:flex;gap:10px;flex-wrap:wrap">
          @include('partials.back', ['fallback' => route('settings.role')])
          <a href="{{ route('role.create') }}"><button class="btn primary" type="button">Tambah Role</button></a>
        </div>
      </div>
            ...
            <tbody>
              @forelse($rows as $r)
                <tr>
                  ...
                  <td>
                    <div class="actions">
                      <a href="{{ route('role.edit', ['id' => $r->id]) }}"><button class="btn" type="button">Edit</button></a>
